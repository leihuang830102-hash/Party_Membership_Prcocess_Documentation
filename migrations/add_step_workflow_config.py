...
STEP_DEFINITIONS_FULL = [
    ...
    ('L3', 1, '推荐入党积极分子', '推荐入党积极分子', 3, 'secretary', 'one_level'),
    ('L4', 1, '确定入党积极分子', '确定入党积极分子', 4, 'secretary', 'one_level'),
    ('L5', 1, '报上级党委备案', '报上级党委备案', 5, 'secretary', 'one_level'),
    ('L6', 1, '积极分子培养、教育、考察', '入党积极分子培养、教育、考察', 6, 'secretary', 'one_level'),
    # 第二阶段：入党积极分子培养
    ('L7', 2, '填写《自传书》', '填写《自传书》', 7, 'applicant', 'two_level'),
    ('L8', 2, '推荐发展对象', '推荐发展对象', 8, 'secretary', 'one_level'),
    ('L9', 2, '发展对象确定并向上级党委备案', '发展对象确定并向上级党委备案', 9, 'secretary', 'one_level'),
    ('L10', 2, '发展对象培养、教育、考察', '发展对象培养、教育、考察', 10, 'secretary', 'one_level'),
    ('L11', 2, '支委会审查', '支委会审查', 11, 'secretary', 'one_level'),
    ('L12', 2, '上级党委预审', '上级党委预审', 12, 'admin', 'none'),
    # 第三阶段：确定发展对象
    ('L13', 3, '填写《入党志愿书》', '填写《入党志愿书》', 13, 'applicant', 'two_level'),
    ('L14', 3, '接收预备党员支部大会', '接收预备党员支部大会', 14, 'secretary', 'one_level'),
    # 第四阶段：接收预备党员
    ('L15', 4, '上级党委派人谈话', '上级党委派人谈话', 15, 'admin', 'none'),
    ('L16', 4, '上级党委审批', '上级党委审批', 16, 'admin', 'none'),
    ('L17', 4, '逐级上报党委组织部门备案', '逐级上报党委组织部门备案', 17, 'admin', 'none'),
    ('L18', 4, '编入党支部、党小组', '编入党支部、党小组', 18, 'secretary', 'one_level'),
    ('L19', 4, '入党宣誓', '入党宣誓', 19, 'secretary', 'one_level'),
    ('L20', 4, '预备党员培养、教育、考察', '预备党员培养、教育、考察', 20, 'secretary', 'one_level'),
    # 第五阶段：预备党员转正

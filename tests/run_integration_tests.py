...
def main():
    ...
    if args.workflow:
        ...
        all_test_paths = [
            ...
            'tests/integration/test_applicant.py',
            'tests/integration/test_secretary.py',

            # 工作流测试
            'tests/integration/test_workflows.py',
            'tests/integration/test_workflow_admin_setup.py',
            'tests/integration/test_workflow_templates.py',
            'tests/integration/test_workflow_rejection.py',
